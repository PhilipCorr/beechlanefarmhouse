...
================================================== -->
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active home button"><a href="../index.html" data-target="home">Home</a></li>
                <li class="activities button"><a href="../activities.html" data-target="activities">Activities</a></li>
                <li class="contact_li button"><a id="contact_link" data-toggle="collapse" href="#collapse1">Contact</a></li>
                <li class="testimonials button"><a href="../testimonials.html" data-target="testimonials">Testimonials</a></li>
                <li class="availability button"><a id="availability_link" href="../availability.html" data-target="availability">Availability</a></li>
              </ul>
            </div>

          <div id="collapse1" class="panel-collapse collapse">  <!-- change this to more robust conditional, force contact form to remain on page after php runs -->
            <div class="row">
            <div id="contact" class="border col-sm-4">
                <form id="form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" role ="form">
                    <fieldset class="contact_border">
                      <div id="contact_statement">
                       ...
                       <label for="email">
                          ...
                          <input id="email" type="email" id="email" name="email" placeholder="example@gmail.com" />
                        </label>
                        <label for="message">
  ...
  <!-- <script type="text/javascript" src="../js/mycal.js"></script> -->
